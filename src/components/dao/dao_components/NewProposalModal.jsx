...
const NewProposalModal = ({ onClose, onCreateProposal }) => {
  ...
  const handleChange = (e) => {
    ...
    setFormData((prev) => ({
      ...prev,
      [name]: name === "duration" || name === "fundsRequested" ? Number(value) : value,
    }))
          ...
          >
            <div className="bg-gradient-to-r from-green-500 to-emerald-600 py-4 px-6">
              <div className="flex justify-between items-center">
                <h3 className="text-lg font-medium text-white">Create New Proposal</h3>
            ...
            <form onSubmit={handleSubmit} className="p-6">
              <div className="space-y-4">
                <div>
                  <label htmlFor="disasterName" className="block text-sm font-medium text-gray-700 mb-1">
                    Disaster Name
                  </label>
                  <input
                    type="text"
                  ...
                  />
                  {errors.disasterName && <p className="mt-1 text-sm text-red-600">{errors.disasterName}</p>}
                </div>
                ...
                <div>
                  <label htmlFor="fundsRequested" className="block text-sm font-medium text-gray-700 mb-1">
                    Funds Requested (USD)
                  </label>
                  <input
                    type="number"
                    ...
                    min="1"
                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 ${
                      errors.fundsRequested ? "border-red-500" : "border-gray-300"
                    }`}
                  />
                  {errors.fundsRequested && <p className="mt-1 text-sm text-red-600">{errors.fundsRequested}</p>}
                </div>
