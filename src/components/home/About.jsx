...
const About = () => {
  ...
  // Refs for Lottie containers (one per step)
  const animationRefs = steps.map(() => useRef(null));
    ...
    const animations = steps.map((step, index) => {
      if (animationRefs[index].current) {
        return lottie.loadAnimation({
          container: animationRefs[index].current,
          renderer: 'svg',
          loop: true,
          autoplay: true,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
            Join our mission to make a difference with a seamless, secure, and rewarding donation process powered by blockchain technology.
          </p>
        </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="mt-6">
                <a
                  href="#donate"
                  className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full font-semibold text-sm sm:text-base shadow-md hover:from-purple-500 hover:to-pink-500 transition-all duration-300"
                >
                  Learn More
                </a>
              </div>
