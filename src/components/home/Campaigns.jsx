...
const Campaigns = () => {
  ...
  const campaigns = [
    {
      ...
      description: 'Support communities devastated by Hurricane X in the Caribbean. Immediate assistance needed for food, shelter, and medical supplies.',
    ...
    },
    {
      ...
      description: 'Aid rebuilding efforts after a 7.2 magnitude earthquake in Southeast Asia. Help provide temporary housing and essential supplies.',
    ...
    },
    {
      ...
      description: 'Provide immediate relief to flood victims in Western Europe. Support evacuation efforts and emergency response teams.',
    ...
    },
    {
      ...
      description: 'Help families displaced by wildfires in North America. Funding goes towards temporary housing and rebuilding efforts.',
  ...
  return (
    <section className="relative py-16 sm:py-24 bg-gradient-to-br from-white to-purple-50 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center px-4 py-1.5 bg-purple-100 rounded-full mb-4">
            ...
            <span className="text-purple-800 font-medium text-sm">Live Campaigns</span>
          </div>
          ...
          <p className="mt-4 text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
            Your donations help us provide critical aid to those in need. Join our global community of donors making a real difference.
          </p>
        </motion.div>
              ...
              <div className="p-6">
                ...
                <div className="mb-4">
                  <div className="flex justify-between text-sm mb-1">
                    <span className="font-semibold text-purple-600">{campaign.totalDonations}</span>
                    <span className="text-gray-500">of {campaign.goal}</span>
                  </div>
                  <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div
                      className="h-full bg-gradient-to-r from-purple-600 to-pink-600 transform origin-left transition-transform duration-500"
                ...
                <div className="grid grid-cols-2 gap-4 mb-6 text-center">
                  <div className="bg-purple-50 rounded-lg p-2">
                    <div className="text-purple-600 font-semibold">{campaign.donors}</div>
                ...
                <div className="flex gap-2">
                  <button className="flex-1 px-4 py-2 text-sm font-semibold text-purple-600 bg-purple-50 rounded-full hover:bg-purple-100 transition-colors duration-300">
                    Learn More
                  </button>
                  <button className="flex-1 px-4 py-2 text-sm font-semibold text-white bg-gradient-to-r from-purple-600 to-pink-600 rounded-full hover:from-purple-500 hover:to-pink-500 transition-colors duration-300">
                    Donate Now
                  </button>
                </div>
              </div>
        ...
        >
          <button className="inline-flex items-center px-8 py-3 bg-white text-purple-600 border-2 border-purple-200 rounded-full font-semibold hover:border-purple-300 hover:bg-purple-50 transition-all duration-300 transform hover:scale-105 shadow-sm">
            View All Campaigns
