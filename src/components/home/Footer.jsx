        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 sm:gap-12">
            ...
            >
              <div className="flex items-center space-x-2">
                <div className="w-10 h-10 bg-gradient-to-br from-purple-600 to-pink-600 rounded-xl shadow-md"></div>
                <span className="text-xl font-extrabold text-white">Relief</span>
              </div>
              <p className="text-sm sm:text-base text-gray-300 leading-relaxed">
                Relief empowers secure, transparent donations using blockchain technology. Join us to make a global impact through crypto-powered disaster relief campaigns.
              </p>
            </motion.div>
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={index}>
                    <a
                      href={link.href}
                      className="text-sm sm:text-base text-gray-300 hover:text-purple-400 transition-colors duration-300"
                    >
                      {link.label}
                    </a>
                  </li>
          ...
          >
            <p className="text-sm sm:text-base text-gray-400">
              ...
              <span className="text-purple-400">♥</span> for a better world.
            </p>
          </motion.div>
        </div>
      </div>
